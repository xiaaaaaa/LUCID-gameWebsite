                ...
                <div className="grid grid-cols-1 gap-6content">
                    <div className="card flex flex-col md:flex-row bg-base-100 w-full shadow-sm">
                        ...
                        <div className="card-body">
                            <h2 className="card-title">簡短故事介紹</h2>
                    ...
                    <div className="card flex flex-col md:flex-row-reverse bg-base-100 w-full shadow-sm">
                        <figure>
                            <img
                                src="https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.webp"
                                alt="Shoes" />
                    ...
                    <div className="card bg-base-100 w-full shadow-sm">
                        ...
                        <div className="card-body">
                            <h2 className="card-title">解謎機制</h2>
                            <p>A card component has a figure, a body part, and inside body there are title and actions parts</p>
                            <div className="card-actions justify-end">
                                <button className="btn btn-primary">Buy Now</button>
                            </div>
