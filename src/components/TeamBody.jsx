                    ...
                    <div className="mt-10 mb-40 ml-5">
                        <LeftfadeInDiv className="flex flex-row">
                            <div className="itemPicFrame pl-2">
                                <img className="memberPic h-[230px] p-5" src="/images/XiaMember.png" alt="MembersPhoto" />
                            </div>
                        ...
                        <RightfadeInDiv className="flex flex-row">
                            <div className="itemPicFrame pl-2">
                                <img className="memberPic h-[230px] p-5" src="/images/XinMember.png" alt="MembersPhoto" />
                            </div>
                            <div className="itemTextFrame h-[230px]">
                        ...
                        <LeftfadeInDiv className="flex flex-row">
                            <div className="itemPicFrame pl-2">
                                <img className="memberPic h-[230px] p-5" src="/images/ChingMember.png" alt="MembersPhoto" />
                            </div>
                            <div className="itemTextFrame h-[230px]">
