                    ...
                    <div className="mt-10 mb-40 ml-5">
                        <LeftfadeInDiv className="flex flex-row">
                            ...
                            <div className="itemTextFrame h-[230px]">
                                ...
                                <a href="https://www.instagram.com/_xiaaaaaa/" className="flex justify-end font-bold memberLink  pr-15">IG @_xiaaaaaa</a>
                            </div>
                        </LeftfadeInDiv>
                        <RightfadeInDiv className="flex flex-row">
                            ...
                            <div className="itemTextFrame h-[230px]">
                                ...
                                <h1 className="flex pt-5 pr-12 text-left">LUCID世界觀的發想大腦，裡面塞著很多設定和想法。喜歡構思角色間的愛恨糾葛，目標是製造錯綜複雜的「貴圈真亂」人物關係圖，目前設計的最開心的角色是花店老闆。自認團隊定位是創意開心果，身分認同是内餡是紅豆泥的菠蘿麵包（很好吃的感覺）。</h1>
                                <a href="https://www.youtube.com/@Alreaxin347/featured" className="flex justify-end font-bold memberLink pr-15">YT @Alreaxin347</a>
                            </div>
                        </RightfadeInDiv>
                        <LeftfadeInDiv className="flex flex-row">
                            <div className="itemPicFrame pl-2">
                            ...
                            <div className="itemTextFrame h-[230px]">
                                ...
                                <h1 className="flex pt-5 pr-12 text-left">LUCID世界觀的發想大腦，裡面塞著很多設定和想法。喜歡構思角色間的愛恨糾葛，目標是製造錯綜複雜的「貴圈真亂」人物關係圖，目前設計的最開心的角色是花店老闆。自認團隊定位是創意開心果，身分認同是内餡是紅豆泥的菠蘿麵包（很好吃的感覺）。</h1>
                                <a href="https://www.instagram.com/ching.819_/?igsh=MXFmOWgzMnBlaDd5#" className="flex justify-end font-bold memberLink  pr-15">IG @ching.819_</a>
                            </div>
                        </LeftfadeInDiv>
                        <RightfadeInDiv className="flex flex-row">
                            <div className="itemPicFrame pl-2">
                            ...
                            <div className="itemTextFrame h-[230px]">
                                ...
                                <h1 className="flex pt-5 pr-12 text-left">LUCID世界觀的發想大腦，裡面塞著很多設定和想法。喜歡構思角色間的愛恨糾葛，目標是製造錯綜複雜的「貴圈真亂」人物關係圖，目前設計的最開心的角色是花店老闆。自認團隊定位是創意開心果，身分認同是内餡是紅豆泥的菠蘿麵包（很好吃的感覺）。</h1>
                                <a href="https://x.com/kame2_star" className="flex justify-end font-bold memberLink pr-15">X @kame2_star</a>
                            </div>
                        </RightfadeInDiv>
                    </div>
                </div>
