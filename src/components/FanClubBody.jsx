                        ...
                        <div className="flex flex-col items-center">
                            <div className="flex flex-col justify-center items-center h-[160px] w-[1200px] fanClubbg rounded-[20px] mt-7">
                                ...
                                <div className="flex flex-col w-270 mt-5">
                                    ...
                                    <progress className="progress w-270 h-5 justify-center" value={20} max="100"></progress>
                                </div>
                            </div>
                            <div className="flex flex-row justify-around items-center mt-10 w-[1200px]">
                                <img className="h-[430px]" src="/images/SideLeft.png" alt="LeftSideImage" />
                                <img className="h-[430px]" src="/images/SideRight.png" alt="RightSideImage" />
                            </div>
                        </div>
                    </div>
                    {/* 趣味問答｜Fun Fact */}
